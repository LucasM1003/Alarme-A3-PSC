...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        do {
            System.out.println("\n--- MENU PRINCIPAL ---");
            System.out.println("1. Criar cadastro de login");
            System.out.println("2. Adicionar dispositivo a um cadastro");
            System.out.println("3. Criar plano de segurança");
            System.out.println("4. Ver eventos e notificações");
            System.out.println("5. Registrar manutenção");
            System.out.println("6. Registrar monitoramento");
            System.out.println("7. Editar cadastro");
            System.out.println("8. Excluir cadastro");
            System.out.println("9. Editar plano de segurança");
            System.out.println("10. Excluir plano de segurança");
            System.out.println("11. Editar/Excluir dispositivo de um cadastro");
            System.out.println("12. Editar/Excluir manutenção");
            System.out.println("13. Editar/Excluir monitoramento");
            ...
            switch (opcao) {
                ...
                case 4 -> {
                    ...
                    for (int i = 0; i < cadastros.size(); i++) {
                        ...
                        System.out.println(i + ": Login: " + c.getLogin() + " | Senha: " + c.getSenha());
                    }
                }
                case 5 -> {
